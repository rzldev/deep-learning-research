...
## Part 1 - Identify the frauds with the Self-Originizing Maps
...
for i, x in enumerate(X):
    w = som.winner(x)
    plot(w[0] + .5, w[1] + .5, markers[y[i]], markeredgecolor= colors[y[i]],
...
# Adding the input layer and this first hidden layer
