...
## Converting the data into an arrat with users in line and movies in columns
def convert(data):
    new_data = []
...
class SAE(nn.Module):
    ...
    super(SAE, self).__init__() => Inherit all the param from parent class
    fc1 => First full connection
    fc2 => Second full connection
    fc3 => Third full connection
    fc4 => Forth full connection
    ...
    '''
    forward => The action that takes place in AutoEncoder
    x => Input vector
    '''
    def forward(self, x):
